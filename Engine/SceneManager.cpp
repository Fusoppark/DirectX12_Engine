...
#pragma region Cube
	{
		...
		}
		{
			...
			shared_ptr<Texture> texture = GET_SINGLE(Resources)->Load<Texture>(L"Metal", L"..\\Resource\\Texture\\Metal_Panel_basecolor.jpg");
			shared_ptr<Texture> texture2 = GET_SINGLE(Resources)->Load<Texture>(L"Metal_Normal", L"..\\Resource\\Texture\\Metal_Panel_normal.jpg");
			shared_ptr<Material> material = make_shared<Material>();
			material->SetShader(shader);
			material->SetTexture(0, texture);
